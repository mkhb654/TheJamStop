...
public class Base {
    ...
    @BeforeSuite
    public void setUp(@Optional("false")boolean useSauceLabs,@Optional("hbogo")String userName,
                      @Optional("208b1c26-5f94-428f-af03-daf9fc6556ae")String key,
                      @Optional("Mac")String os, @Optional("firefox")String browser,@Optional("27")String browserVersion,
                      @Optional("http://www.hbogo.com")String url) throws IOException {
...
//          System.setProperty("webdriver.chrome.driver","/chromedriver/chromedriver.exe");
            System.setProperty("webdriver.chrome.driver","../Generic/selenium-driver/chromedriver");
